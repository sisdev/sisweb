...
9999-283-283</td></tr>";
     ...
     $result=mail($email,$std_subject,$std_message,$std_headers);
 ...
 <div class="form-group">
  ...
  <div class="col-md-5">
    <select id="applyfor" name="category" class="form-control">
	 ...
	 <option value="Demo Class-Online">Demo class - Online</option>	
     <option value="Demo Class-ClassRoom" selected>Demo Class - Class Room</option>
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input type="text" id="ser" name="serv_desc"   class="form-control input-md" placeholder="Android, MS Project, English Comm etc"  required="">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <textarea id="mob" name="address"   rows="1" class="form-control input-md" required=""></textarea>
  ...
  <div class="col-md-5">
  <input id="name" name="mobile"  maxlength="20"  class="form-control input-md" required="" type="text">
  ...
  <div class="col-md-5">
  <input id="name" name="email"  maxlength="128"  class="form-control input-md" required="" type="email">
	...
	<div class="form-group">
  <label class="col-md-3 control-label" for="name">Word verification:</label>  
  <div class="col-md-5">
  <input id="name" name="captcha"  maxlength="20"  class="form-control input-md" required="" type="text" style="background-position: right; background-image:url('PHP-CAPTCHA/php_captcha.php'); background-size:20% 100%;
