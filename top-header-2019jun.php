 ...
 <div class="templatemo-top-menu">
            ...
            <div class="row" style="display:block;">
                        <div class="navbar-header">
                                <button type="button" id="nav_icon_div" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                                <span class="sr-only">Toggle navigation</span>
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                                <span class="icon-bar"></span>
                                </button>
                                <a href="index.php" class="navbar-brand"><img src="images/logo-sisoft.jpg" alt="Sisoft Learning" title="Sisoft Learning" height="95" width="95"  /></a>
								<span style="font-size:80px;"> Sisoft </span>	
                        </div>
    ...
    <!--        <form class="search-form" role="search">
        <div class="form-group pull-right" id="search">
          ...
          <span class="search-label"><i class="glyphicon glyphicon-search"></i></span>
              ...
              <div class="col-xs-12 col-sm-12 col-md-12 col-lg-4" id='search_div'>
                <Input id="searchCourse" type ="text" placeholder="Search here for courses" style="width:300px; padding:5px 4px; margin-top:1	px;" onKeyUp="searchCourses(this.value)">
                <div id="searchOutput" style="height:auto; display:none; z-index:1; border:1px solid gray;"></div>
