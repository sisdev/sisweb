...
<li ><a href="training_project_mgnt.php?a=30">Project Managment</a>
<ul>                
	<li <?php if($_GET["a"]==30) { ?>  style= "background-color: black";  <?php } ?>><a href="Project_Management">Project Management</a></li>
	<li <?php if($_GET["a"]==19) { ?>  style= "background-color: black";  <?php } ?>><a href="MS_Project"> MS Project</a></li>                
	<li <?php if($_GET["a"]==18) { ?>  style= "background-color: black";  <?php } ?>><a href="PMP_Certification">PMP Certification</a></li>                
	<li <?php if($_GET["a"]==30) { ?>  style= "background-color: black";  <?php } ?>><a href="PMCO">PMCO Certification</a></li>
    <li> <a href="Prince2"> Prince 2 </a></li>
    <li> <a href="ITIL">ITIL </a> </li>
    <li> <a href="Agile_Scrum">Agile Scrum </a></li>
    <li> <a href="SixSigma_GreenBelt">Six Sigma - GB</a> </li>              
</ul>
  ...
  <a href="training_softskills.php?a=201" class="btn btn-primary btn-block" role="button">Soft skills</a>     
...
<form id="left-menu" action="#" method="post">
          <select onChange="javascript:window.location=''+this.value+''">
             ...
             <option value="training_project_mgnt.php?a=16">iPhone</option>
			 <option value="training_project_mgnt.php?a=17">Android App</option>
			 <option value="training_project_mgnt.php?a=66">Android Game</option>
			 <option value="training_project_mgnt.php?a=65">Android Testing</option>
			 <option value="training_project_mgnt.php?a=60">Windows</option>
			 <option value="training_project_mgnt.php?a=61">HTML5</option>
			 <option value="training_smac.php?a=80">Big Data</option>
			 <option value="training_smac.php?a=85">Cloud Computing</option>

             
             <option value="training_project_mgnt.php?a=63">Ethical Hacking</option>
			 <option valuef="training_project_mgnt.php?a=34">Embedded System</option>
			 <option value="training_project_mgnt.php?a=67">Linux Device Drivers</option>
			 <option value="training_project_mgnt.php?a=1" >Computer Fundamentals</option>
			 <option value="training_project_mgnt.php?a=70">TallyERP.9</option>
			 <option value="training_project_mgnt.php?a=33">Advance Excel</option>
			 <option value="training_project_mgnt.php?a=2">DOEACC</option>
			 <option value="training_project_mgnt.php?a=8">Graphics Design</option>
			 <option value="training_project_mgnt.php?a=36">Web Site Design</option>
			 <option value="training_project_mgnt.php?a=32">SEO</option>
			 <option value="training_project_mgnt.php?a=3">C</option>
			 <option value="training_project_mgnt.php?a=4">C++</option>
			 <option value="training_project_mgnt.php?a=400">C++( B.Tech )</option>
			 <option value="training_project_mgnt.php?a=5">Core Java</option>
			 <option value="training_project_mgnt.php?a=38">Advance Java/J2EE</option>
			 <option value="training_project_mgnt.php?a=6">.Net</option>
			 <option value="training_project_mgnt.php?a=7">PHP &amp; MySQL</option>
			 <option value="training_project_mgnt.php?a=35">Linux</option>
			 <option value="training_project_mgnt.php?a=9">CCNA</option>
			 <option value="training_project_mgnt.php?a=12">Oracle</option>
			 <option value="training_project_mgnt.php?a=13">Siebel</option>
			 <option value="training_project_mgnt.php?a=14">SAP</option>
		     <option value="training_project_mgnt.php?a=15">Software Testing</option>
             
             <option value="training_project_mgnt.php?a=30">Project Managment</option>
             <option value="training_project_mgnt.php?a=20">Soft Skill Training</option>
		  </select>
</form> 
            </aside>
...
mysqli_close($conn);
	...
	{
	?>
	<marquee behavior="alternate" onmouseover=stop() onmouseout=start() ><div class="register" style="background:url(images/Register-bg.png) no-repeat; margin-bottom:10px;"> 
